    ...
    def on_message(self, ws, message):
        ...
        try:
            ...
            if msg.get('topic') == '/chatter':
                ...
                print(f"Received chatter message #{self.message_count['chatter']}: {msg['msg']['data']} [{'✓' if is_valid else '✗'}] ({data_size} bytes)")
                ...
                print(f"Received pointcloud message #{self.message_count['pointcloud']}: {num_points} points [{'✓' if is_valid else '✗'}] ({data_size} bytes)")
